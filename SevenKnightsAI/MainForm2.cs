...
namespace SevenKnightsAI
{
    public partial class MainForm2 : Form
    {
        ...
        public static MainForm2 Instance
        {
            get;
        ...
        private void AppendLog(string message, Color color)
        {
            ...
            RichTextBox logsBox = this.LG_logTextBox;
        ...
        private void PauseAI()
        {
            ...
            this.tabControl1.SelectedTab = reportTab;
        }
    ...
    public class AutoClosingMessageBox_2
    {
        System.Threading.Timer _timeoutTimer;
        string _caption;
        AutoClosingMessageBox_2(string text, string caption, int timeout)
        {
            _caption = caption;
        ...
        {
            new AutoClosingMessageBox_2(text, caption, timeout);
        }
